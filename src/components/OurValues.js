      ...
      <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded-3xl"
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <div>
                ...
                <h4 className="text-3xl text-blue-600">
                  <b>Values We Give to You</b>
                </h4>

                <p>
                    We are always ready to help you by providing the best services for you.
                    We believe a good place to live can make your life better and comfortable.
                </p>
              </div>
              ...
              >
                <div className="accordion-item">
                  <h2 className="accordion-header">
                    ...
                    >
                      <b>Best Interest Rates on the Market</b>
                    </button>
                  </h2>
                  <div
